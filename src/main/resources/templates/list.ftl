	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.employee.name" id="ename" class="employeename form-control input-sm" placeholder="Enter your name" required ng-minlength="3"/>
	                        </div>
	                    </div>
	                </div>
	                ...
	                <div class="row">
	      	        ...
	      	        <div class="row">
	                    <div class="form-group col-md-12">
	                        <label class="col-md-2 control-lable" for="pOrg">Previous Organization</label>
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.employee.previousOrganization" id="pOrg" class="form-control input-sm" placeholder="Enter your Previous Org." required/>
	                        </div>
	                    </div>
	                </div>
	                    ...
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.employee.city" id="city" class="form-control input-sm" placeholder="Enter your city." required />
	                        </div>
	                    </div>
	                </div>
	                    ...
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-7">
	                            <input type="text" ng-model="ctrl.employee.state" id="state" class="form-control input-sm" placeholder="Enter your State." required/>
	                        </div>
	                    </div>
	                </div>
